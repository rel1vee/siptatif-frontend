                      ...
                      <td className="size-px whitespace-nowrap">
                        ...
                        >
                          <span className="px-6 py-1.5">
                            <span className="inline-flex items-center justify-center gap-2 px-2 py-1 text-sm font-medium align-middle transition-all border border-gray-200 bg-white text-red-500 rounded-lg shadow-sm hover:bg-red-50 disabled:opacity-50 disabled:pointer-events-none">
