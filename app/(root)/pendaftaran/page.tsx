                ...
                <tbody className="divide-y divide-gray-200">
                  {pendaftaran.map((p) => (
                    <tr key={p._id}>
                      ...
                      <td className="size-px w-96 min-w-96">
                        <div className="px-6 py-3">
                      ...
                      <td className="size-px whitespace-nowrap">
                        ...
                        >
                          <div className="px-3 py-3">
                            <span className="inline-flex items-center justify-center gap-x-1 px-1.5 py-1 text-xs font-medium text-red-500 align-middle transition-all bg-white border border-gray-200 rounded-lg shadow-sm hover:bg-red-50 disabled:opacity-50 disabled:pointer-events-none">
